...
#line 209 "parser1.y" /* yacc.c:1646  */
    {if((yyvsp[-1])!=1){printf("ERROR: Here, condition must have integer value!\n");exit(0);}}
...
#line 217 "parser1.y" /* yacc.c:1646  */
    {if((yyvsp[0])!=1){printf("Here, condition must have integer value!\n");exit(0);}}
...
#line 226 "parser1.y" /* yacc.c:1646  */
    {if(strcmp(currfunctype,"void")) {printf("ERROR: Cannot have void return for non-void function!\n"); exit(0);}}

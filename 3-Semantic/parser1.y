...
conditional_statements 
			: IF '(' simple_expression ')' {if($3!=1){printf("ERROR: Here, condition must have integer value!\n");exit(0);}} statement extended_conditional_statements;
...
iterative_statements 
			: WHILE '(' simple_expression ')'{if($3!=1){printf("ERROR: Here, condition must have integer value!\n");exit(0);}} statement 
			| FOR '(' for_initialization simple_expression ';' {if($5!=1){printf("Here, condition must have integer value!\n");exit(0);}} expression ')' 
			| DO statement WHILE '(' simple_expression ')' {if($5!=1){printf("ERROR: Here, condition must have integer value!\n");exit(0);}} ';';
...
return_statement 
			: RETURN ';' {if(strcmp(currfunctype,"void")) {printf("ERROR: Cannot have void return for non-void function!\n"); exit(0);}}
